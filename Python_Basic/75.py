# In this part I will learn about "Function Caching"
...
def my_func(n):
    time.sleep(3)
    return f"The Value is : {n}"

print("Function launched Successfully\nWait for the result!\n")
print(my_func(3))
print(my_func(7))
print()
...
""" Function caching is a technique for improving the performance of a program by storing the results of a function so that you can reuse the results instead of recomputing them every time the function is called. 
    ...
    Whether you're writing a computationally expensive program, or just want to simplify your code, function caching is a great technique to have in your toolbox. """